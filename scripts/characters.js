...
export default [
    ...
    {
        imageUrl:ImageRoute + 'caballero.png',
        name:'Caballero',
    ...
    {
        imageUrl:ImageRoute + 'los-pillos.png',
        name:'Los pillos',
    ...
    {
        imageUrl:ImageRoute + 'goblin.png',
    ...
    {
        imageUrl:ImageRoute + 'arquero.png',
        name:'Arquero',
    ...
    {
        imageUrl:ImageRoute + 'montaPuercos.png',
        name:'Montapuercos',
    ...
    {
        imageUrl:ImageRoute + 'Miner_info.png',
        name:'Minero',
    ...
    {
        imageUrl:ImageRoute + 'principe.png',
        name:'Príncipe',
